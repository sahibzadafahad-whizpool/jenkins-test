...
import { StaffDataService } from './staff.service'; // service for calling Node API's
...
export class StaffComponent implements OnInit {
  ...
  constructor(
    private _teachersDataService: StaffDataService,
  ...
  setUserName(mobile_number) {
    ...
    if (mobile_number) {
      ...
      this.default_password = 'staff@' + mobile_first_four_digits;
    }
